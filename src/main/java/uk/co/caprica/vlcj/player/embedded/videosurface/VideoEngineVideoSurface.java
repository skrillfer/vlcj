...
public final class VideoEngineVideoSurface extends VideoSurface {
    ...
    public void attach(LibVlc libvlc, MediaPlayer mediaPlayer) {
        libvlc.libvlc_video_set_output_callbacks(mediaPlayer.mediaPlayerInstance(), engine.intValue(), setup, cleanup, updateOutput, swap, makeCurrent, getProcAddress, null);
    }
